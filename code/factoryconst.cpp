...
/*méthode static qui permet de créer et renvoyer un pointeur vers la Constante de type T,
 créée par val, qui contient une chaine correspond �  une Constante de type Tdonne
 */
...
/*méthode static qui permet de créer et renvoyer un pointeur vers la Constante de type T,
 créée par val, qui contient une chaine correspond �  une Constante de type Tdonne.
 Avec Tcomplexe, le type du Complexe �  partir duquel la Constante doit etre créée
 */
